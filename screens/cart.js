import { View, Text, ScrollView, Pressable, TextInput, Image } from 'react-native' // ✅ added TextInput and Image
import React from 'react'
import {Feather} from "@expo/vector-icons";
import { AntDesign } from '@expo/vector-icons';
import {useDispatch, useSelector} from "react-redux";
import {incrementQuantity, decrementQuantity, removeFromCart} from "../redux/cartReducer"; // ✅ added removeFromCart
...
const CartScreen = () => {
  ...
  const deleteItem = (item)=>{
    dispatch(removeFromCart(item)); // ✅ fixed: was calling removeFromCart without import
  }
      ...
      <View style={{marginHorizontal: 10}}>
        {cart?.map((item, index)=>(
          <View style={{marginVertical: 10, backgroundColor: "white", borderWidth: 2, borderBottomColor: "#F0F0F0", borderLeftWidth: 0, borderTopWidth: 0, borderRightWidth: 0}} key={index}>
            ...
            <Pressable style={{marginTop: 15, marginBottom: 10, flexDirection: "row", alignItems: "center", gap: 10}}>
              <View style={{flexDirection: "row", alignItems: "center", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 6}}>
                ...
                <Pressable 
                  ...
                  style={{backgroundColor: "#D8D8D8", padding: 7, borderTopRightRadius: 6, borderBottomRightRadius: 6}}>
            ...
            {/* Save / See More */}
            <Pressable style={{flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 20}}>
